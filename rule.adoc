= RoboCupJunior Rescue Maze Entry - Rules 2022
Last update: {docdate}
:toc: macro
:toc-title: Contents
:sectanchors:
...
Maze Entry Working Group are the only official rules for  RoboCupJunior Rescue Maze Entry 2022. The translated versions that can be published by each
